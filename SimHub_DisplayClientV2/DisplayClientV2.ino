...
//"0,Potentiometer;1,Button;2,RaceX plugin"
#if (GAMEPAD_AXIS_CLUTCH_ENABLED == 1)
#if (GAMEPAD_AXIS_CLUTCH_BITEPOINT_TYPE == 0)
SHGamepadClutch SHGAMEPADCLUTCH(
  GAMEPAD_AXIS_CLUTCH_LEFT_PIN,
  GAMEPAD_AXIS_CLUTCH_RIGHT_PIN,
  GAMEPAD_AXIS_CLUTCH_LEFT_MINVALUE,
  GAMEPAD_AXIS_CLUTCH_LEFT_MAXVALUE,
  GAMEPAD_AXIS_CLUTCH_LEFT_EXPONENTIALFACTOR,
  GAMEPAD_AXIS_CLUTCH_RIGHT_MINVALUE,
  GAMEPAD_AXIS_CLUTCH_RIGHT_MAXVALUE,
  GAMEPAD_AXIS_CLUTCH_RIGHT_EXPONENTIALFACTOR,
  GAMEPAD_AXIS_CLUTCH_BITEPOINT_PIN,
...
Joystick_ Joystick(JOYSTICK_DEFAULT_REPORT_ID,
	...
	false, false, false, GAMEPAD_AXIS_CLUTCH_ENABLED, false, false,
...
#endif
#if(GAMEPAD_AXIS_CLUTCH_ENABLED == 1)
	SHGAMEPADCLUTCH.update();
  #if(GAMEPAD_AXIS_CLUTCH_BITEPOINT_TYPE == 2)
  SHGAMEPADCLUTCH.setBitePoint(shCustomProtocol.getBitePoint());
  #endif
#endif
#ifdef  INCLUDE_ENCODERS
...
#endif
#if(GAMEPAD_AXIS_CLUTCH_ENABLED == 1)
	SHGAMEPADCLUTCH.SetJoystick(&Joystick);
#endif
#ifdef INCLUDE_GAMEPAD
	Joystick.sendState();
#endif
